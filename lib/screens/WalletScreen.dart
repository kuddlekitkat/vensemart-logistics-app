...
class WalletScreenState extends State<WalletScreen> {
  ...
  void init() async {
    ...
    getWalletData().then((value) {
      ...
      walletData = value.walletHistory!;
                  ...
                  children: [
                    ...
                    AnimationLimiter(
                      child: ListView.builder(
                        ...
                        itemCount:
                            walletData.length == 5 ? 5 : walletData.length,
                        shrinkWrap: true,
                        itemBuilder: (_, index) {
                          // WalletModel data = walletData[index];
                          WalletHistory data = walletData[index];
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                        "${data.status == "2" ? "+" : "-"} ${printAmount(data.amount!)}",
                                        style: boldTextStyle(
                                            color: data.status == "2"
                                                ? Colors.green
                                                : Colors.red))
