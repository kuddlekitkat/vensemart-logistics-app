                ...
                Row(
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: commonCachedNetworkImage(widget.userData!.profile.validate(), height: 45, width: 45, fit: BoxFit.cover),
                    ),
                    SizedBox(width: 12),
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        SizedBox(height: 4),
                        Text(widget.userData!.name.validate(), style: boldTextStyle(size: 14)),
                        SizedBox(height: 4),
