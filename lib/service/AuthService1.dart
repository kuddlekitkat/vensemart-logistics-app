...
//           /// Create user
//           // userModel.userdata!.uid = currentUser.uid.validate();
//           userModel.userdata!.email = email;
//           userModel.userdata!.contactNumber = mobileNumber.validate();
//           userModel.userdata!.username = userName.validate();
//           userModel.userdata!.userType = userType.validate();
//           userModel.userdata!.displayName = fName.validate() + " " + lName.validate();
//           userModel.userdata!.firstName = fName.validate();
//           userModel.userdata!.lastName = lName.validate();
//           userModel.userdata!.createdAt = Timestamp.now().toDate().toString();
//           userModel.userdata!.updatedAt = Timestamp.now().toDate().toString();
//           userModel.userdata!.playerId = sharedPref.getString(PLAYER_ID).validate();
