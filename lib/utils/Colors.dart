...
Color primaryColor = Color(0xFF1456F1);
Color secondaryColor = Color(0xFF003399);
Color tertiaryColor = Color(0xFFF6F8FE);
Color borderColor = Color(0xFFB9B9DC);
const scaffoldSecondaryDark = Color(0xFF1E1E1E);
const scaffoldColorDark = Color(0xFF1456F1);
// const scaffoldColorLight = Colors.white;
const appButtonColorDark = Color(0xFF1456F1);
const dividerColor = Color(0xFFD3D3D3);
const textPrimaryColor = Color(0xFF1456F1);
const textSecondaryColor = Color(0xFF003399);
const viewLineColor = Color(0xFFEAEAEA);
const inputFillColor = Color(0xFFF6F8FE);
