...
String paymentStatusInt(String paymentStatus) {
  if (paymentStatus == 0) {
    return language.pending;
...
oneSignalSettings() async {
  ...
  OneSignal.Notifications.requestPermission(true).then((accepted) {
    ...
    if (accepted) {
      // OneSignal..promptForPushNotificationsWithUserRespRonse();
...
Future<void> saveOneSignalPlayerId() async {
  ...
  OneSignal.User.pushSubscription.addObserver((state) async {
    ...
    print("Player Token" + OneSignal.User.pushSubscription.token.toString());
    print("Player Id" + OneSignal.User.pushSubscription.id.toString());
  });
}
