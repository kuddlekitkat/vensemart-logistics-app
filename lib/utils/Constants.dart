...
//region App name
const mAppName = 'Vensemart Logistics';
//endregion

//region Google map key
const GOOGLE_MAP_API_KEY = 'AIzaSyAg5nyQAzPupKmzUJKyM-Rp09gAmGJqzyc';
//endregion

//region DomainUrl
const DOMAIN_URL =
    // 'http://10.0.2.2:8000'; // Don't add slash at the end of the url
    'https://api.vensemart.com'; // Don't add slash at the end of the url
//endregion
...
const MQTT_UNIQUE_TOPIC_NAME =
    'vensemartlogi'; // Don't add underscore at the end of the url
// 'ADD YOUR MQTT UNIQUE TOPIC NAME'; // Don't add underscore at the end of the url
//endregion

//region OneSignal Keys
//You have to generate 2 onesignal account one for rider and one for driver
const mOneSignalAppIdDriver = 'e5db6fdd-df18-49a3-b1c7-c2c27645e144';
const mOneSignalRestKeyDriver = 'ADD YOUR ONESIGNAL DRIVER REST API KEY';

const mOneSignalAppIdRider = '580dc8b3-a23b-4ef4-9ec9-fa1fd78c83bb';
...
const PDF_NAME = 'Vensemart Logistics Private Limited';
...
const PICKINGUP = 'picking_up';
const PICKUP = 'picked_up';
